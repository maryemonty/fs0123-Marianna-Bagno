...
for (let n of starWarsCharacters) {
...
for (let n of starWarsCharacters) {
  if (n.gender == "female"){
    femaleCharacters.push(n.name);
    femaleCharacters.push(n.hair_color);
    femaleCharacters.push(n.eye_color);
  }
}
...
/* ESERCIZIO 5
  ...
  */
  ...
  for (let n of starWarsCharacters){
    switch(n.eye_color){
      case 'blue':
        eyeColor.blue.push(n);
        break;
      case 'yellow':
        eyeColor.yellow.push(n);
        break;
      case 'brown':
        eyeColor.brown.push(n);
        break;
      case 'red':
        eyeColor.red.push(n)
        break;
      case 'blue-gray':
        eyeColor.blueGray.push(n)
        break;
      default:
